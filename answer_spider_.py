...
texts = html_xpath.xpath('string(/html/body/div[1]/div/main/div/div/div[3]/div[1]/div/div[2]/div/div/div/div[3]/div[1]/span)')#获取文本
try:
    first_texts = html_xpath.xpath('string(/html/body/div[1]/div/main/div/div/div[3]/div[1]/div/div[2]/div/div/div/div[3]/div[1]/span/p[1])')
except:
    print('第一行获取失败')
#print(first_texts)
